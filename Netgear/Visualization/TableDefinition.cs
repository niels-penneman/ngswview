...
namespace Netgear.Visualization
{
    ...
    {
        public TableDefinition(TablePropertyDefinition<T> header, IEnumerable<TableCategoryDefinition<T>> categories)
        {
            Header = header;
            Categories = categories;
        }

        public IEnumerable<TableCategoryDefinition<T>> Categories { get; }
        public TablePropertyDefinition<T> Header { get; }
    }
}