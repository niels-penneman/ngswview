...
namespace Netgear
{
    public enum SpanningTreeVersion
    {
        [ConfigurationToken("802.1s")]
        [Description("MSTP (802.1s)")]
        Mstp,
        
        [ConfigurationToken("802.1w")]
        [Description("RSTP (802.1w)")]
        Rstp,
        
        [ConfigurationToken("802.1d")]
        [Description("STP (802.1d)")]
        Stp
    }
}